 ...
 * @author l.buchner
 */
public class KassiopeiaTimeSeriesConverter implements TimeSeriesConverter<TimeSeries<Long, Double>> {

    private static final Logger LOGGER = LoggerFactory.getLogger(KassiopeiaTimeSeriesConverter.class);
